...
class ModuleSpec(TypedDict):
    ...
    Usage:
        ...
        >>> from ren_openpi0.model.components.transformer import Transformer
        >>> spec = ModuleSpec.create(Transformer, num_layers=3)
        # Same as above using the fully qualified import string:
        >>> spec = ModuleSpec.create("ren_openpi0.model.components.transformer:Transformer", num_layers=3)
    ...
    def create(
        ...
        Args:
            callable_or_full_name (str or object): Either the object itself or a fully qualified import string
                (e.g. "ren_openpi0.model.components.transformer:Transformer")
