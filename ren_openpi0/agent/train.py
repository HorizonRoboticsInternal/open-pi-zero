...
import wandb
from ren_openpi0.agent.dataset import TorchRLDSInterleavedDataset
from ren_openpi0.agent.model_averaging import ModelAveraging
from ren_openpi0.model.vla.pizero import PiZero
from ren_openpi0.model.vla.processing import VLAProcessor
from ren_openpi0.utils.decorator import main_rank_only
from ren_openpi0.utils.metric import get_action_accuracy
from ren_openpi0.utils.monitor import (
    MainRankFilter,
    Timer,
    log_allocated_gpu_memory,
    log_execution_time,
)
from ren_openpi0.utils.optim import CosineAnnealingWarmupRestarts, get_num_params_in_billions
...
class TrainAgent:
    ...
    def load_optimizer(self, path: str):
        """load to cpu first, then move to gpu"""
        from ren_openpi0.utils.optim import optimizer_to
